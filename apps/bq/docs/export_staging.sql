...
-- isin;issuer;name;certificate_type_tags;memory_effect;phase;currency;industry;callable;strike_date;issue_date;rembursement_date;autocallable_date;capital_barrier;airbag;risk_level;coupon_amount;coupon_type;coupon_barrier;leverage;exchange_risk
EXPORT DATA OPTIONS (
...
AS
SELECT isin,issuer,name,certificate_type_tags,memory_effect,phase,currency,industry,callable,strike_date,issue_date,rembursement_date,autocallable_date,capital_barrier,airbag,risk_level,coupon_amount,coupon_type,coupon_barrier,leverage,exchange_risk
